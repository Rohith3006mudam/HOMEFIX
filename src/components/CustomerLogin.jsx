...
export default function CustomerLogin({ onBack, onAuthenticated, onSignupClick }) {
    ...
    <main className="center-page auth-page">
      <div className="auth-container">
        ...
        <div className="auth-content">
          <span className="eyebrow">HOMEFIX</span>
          <h1>Customer Login</h1>
          <p className="lead">Sign in to book services and manage your orders.</p>
          ...
          <p className="auth-footer">
            Don't have an account? <button className="text-btn" onClick={onSignupClick}>Sign up</button>
          </p>
        </div>
      </div>
    </main>
